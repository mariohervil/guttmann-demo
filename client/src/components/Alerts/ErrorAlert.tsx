...
const ErrorAlert = (props: { visibility: boolean }) => {
	...
	return (
		<div
			...
			} alert alert-error shadow-lg flex flex-col`}
		>
			<div>
				<svg
				...
				<span className="text-left">Ups. Ha ocurrido un error.</span>
			</div>
			<div className="h-1 bg-transparent dark:bg-opacity-50 rounded-xl overflow-hidden">
				<div className="h-full bg-red-600 rounded-xl" style={{ width: `${progress}%` }}>
